...
export const sidebar = [
  ...
  createSidebarItem(4, <Users color="rgb(var(--main-Color))" size={24} strokeWidth={0.9} />, 'Группы', false, '/groups/'),
  createSidebarItem(5, <CalendarCheck color="rgb(var(--main-Color))" size={24} strokeWidth={0.9} />, 'События', false, '/events/'),
  createSidebarItem(6, <Heart color="rgb(var(--main-Color))" size={24} strokeWidth={0.9} />, 'Подписки', true, '/subs/'),
  createSidebarItem(7, <Network color="rgb(var(--main-Color))" size={24} strokeWidth={0.9} />, 'Графы', false, '/graphs/'),
