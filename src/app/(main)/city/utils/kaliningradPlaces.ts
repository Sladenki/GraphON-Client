...
export const KALININGRAD_PLACES: PlaceCoordinates[] = [
  ...
  // Культурные объекты
  { lat: 54.71969, lng: 20.492638, name: "Драмтеатр", aliases: ["драмтеатр", "драматический театр", "театр"] },
  { lat: 54.7070, lng: 20.5050, name: "Дворец культуры", aliases: ["дворец культуры", "дк"] },
  { lat: 54.7206, lng: 20.4829, name: "Кинотеатр Заря", aliases: ["кинотеатр заря", "заря", "кинотеатр"] },
  ...
  { lat: 54.9456, lng: 20.1595, name: "Янтарь-Холл", aliases: ["янтарь-холл", "янтарь холл", "холл"] },
  ...
  { lat: 54.7150, lng: 20.5130, name: "Лаунж-бар «Pravda»", aliases: ["лаунж-бар pravda", "pravda", "лаунж бар", "правда"] },
  ...
  // Кафе и рестораны
  { lat: 54.9581, lng: 20.4712, name: "Кафе «Солёная ворона»", aliases: ["кафе солёная ворона", "солёная ворона", "солевая ворона", "ворона"] },
  { lat: 54.719539, lng: 20.518896, name: "Ресторан «Мушкино»", aliases: ["ресторан мушкино", "мушкино", "ресторан мушкіна", "mushkino"] },
];
