...
import { treeGraphData } from '@/utils/treeGraphData';
...
const SecondVariant  = ({ searchQuery }: { searchQuery: string}) => {
    ...
    <div className={styles.graphWrapper}>
      <div className={styles.graphContainer}>
        <ForceGraph2D
          ...
          nodeAutoColorBy={null} // Отключаем автоматическое определение цвета
          enableNodeDrag={false} // Отключаем перетаскивание
          ...
          // Убираем силы для физической симуляции
          // d3Force="charge"
