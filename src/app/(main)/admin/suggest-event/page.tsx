...
import styles from './suggestEvent.module.scss';
...
export default function SuggestEventPage() {
  ...
  const handleSuccess = () => {
    // Возвращаемся на /admin после успешного предложения
    setTimeout(() => {
      router.push('/admin');
    }, 1000);
  };
  ...
  return (
    <div className={styles.page}>
      <div className={styles.headerBar}>
        ...
        <h2 className={styles.headerTitle}>Предложение события</h2>
      </div>

      <div className={styles.content}>
        <div className={styles.header}>
          <h1 className={styles.title}>Предложить мероприятие</h1>
